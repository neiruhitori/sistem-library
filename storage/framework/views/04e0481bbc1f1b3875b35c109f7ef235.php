            ...
            <div class="row mb-2 align-items-center">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right bg-light px-2 py-1 rounded shadow-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="<?php echo e(route('catatantahunan.index')); ?>">
    ...
    <div class="container mt-4">
        <div class="card shadow">
            ...
            <div class="card-body">
                ...
                <?php if($catatan->referensi_id && $catatan->peminjamantahunan): ?>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text mb-1">
                                            <small class="text-muted">
                                                ...
                                                <?php echo e($detail->kodeBuku->buku->kelas ?? '-'); ?>
                ...
                <div class="d-flex justify-content-between align-items-center mt-3">
                    ...
                    <div>
                        <a href="<?php echo e(route('catatantahunan.export', $catatan->id)); ?>" target="_blank"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sistem-library\resources\views/catatantahunan/show.blade.php ENDPATH**/ ?>