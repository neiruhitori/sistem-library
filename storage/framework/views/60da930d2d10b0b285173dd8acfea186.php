<?php $__env->startSection('title', 'Peminjaman Tahunan'); ?>
            ...
            <div class="card shadow mt-3">
                ...
                <div class="card-body">
                    <div class="mb-3 d-flex gap-2">
                        <a href="<?php echo e(route('peminjamantahunan.create')); ?>" class="btn btn-success">
                            <i class="fas fa-plus"></i> Tambah Peminjaman
                        </a>
                        <form action="<?php echo e(route('peminjamantahunan.hapussemua')); ?>" method="POST"
                            onsubmit="return confirm('Yakin ingin menghapus semua data peminjaman tahunan?')"
                            class="d-inline">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('DELETE'); ?>
                            <button type="submit" class="btn btn-danger" 
                                <?php echo e($userPeminjamanCount == 0 ? 'disabled' : ''); ?>

                                <?php echo e($userPeminjamanCount == 0 ? 'title="Tidak ada data peminjaman untuk dihapus"' : ''); ?>>
                                <i class="fas fa-trash-alt"></i> Hapus Semua Peminjaman
                                <?php if($userPeminjamanCount > 0): ?>
                                    <span class="badge badge-light ml-1"><?php echo e($userPeminjamanCount); ?></span>
                                <?php endif; ?>
                            </button>
                        </form>
                    </div>
    ...
    <script>
        $(function() {
            $('#example1').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '<?php echo e(route('peminjamantahunan.index')); ?>',
                    type: 'GET',
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sistem-library\resources\views/peminjamantahunan/index.blade.php ENDPATH**/ ?>