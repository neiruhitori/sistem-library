        ...
        document.getElementById('pay-button').addEventListener('click', function(e) {
            ...
            snap.pay('<?php echo e($catatan->snap_token); ?>', {
                onSuccess: function(result) {
                    ...
                    form.method = 'POST';
                    form.action = "<?php echo e(route('catatanharian.midtrans.success', $catatan->id)); ?>";
                ...
                onPending: function(result) {
                    ...
                    window.location.href = "<?php echo e(route('catatanharian.show', $catatan->id)); ?>";
                },
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sistem-library\resources\views/catatanharian/payment.blade.php ENDPATH**/ ?>