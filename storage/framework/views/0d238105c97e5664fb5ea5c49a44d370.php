                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $topBorrowers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $borrower): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            ...
                                            <td><span class="badge badge-info"><?php echo e($borrower->siswa->siswaPeriodeAktif->kelas ?? '-'); ?></span></td>
                                            <td>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-6">
                        <a href="<?php echo e(route('buku.create')); ?>?tipe=harian" class="btn btn-success btn-block btn-lg">
                    ...
                    <div class="col-6">
                        <a href="<?php echo e(route('buku.create')); ?>?tipe=tahunan" class="btn btn-primary btn-block btn-lg">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-6">
                        <a href="<?php echo e(route('peminjamanharian.create')); ?>" class="btn btn-warning btn-block btn-lg">
                            <i class="fas fa-calendar-day fa-2x mb-2"></i><br>
                    ...
                    <div class="col-6">
                        <a href="<?php echo e(route('peminjamantahunan.create')); ?>" class="btn btn-info btn-block btn-lg">
                            <i class="fas fa-calendar-alt fa-2x mb-2"></i><br>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="d-grid gap-2">
                    <a href="<?php echo e(route('buku.create', ['tipe' => 'harian'])); ?>" class="btn btn-lg btn-primary">
                        <i class="fas fa-calendar-day"></i> Tambah Buku Harian
                    </a>
                    <a href="<?php echo e(route('buku.create', ['tipe' => 'tahunan'])); ?>" class="btn btn-lg btn-info">
...
<div class="modal fade" id="peminjamanModal" tabindex="-1" aria-labelledby="peminjamanModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="d-grid gap-2">
                    <a href="<?php echo e(route('peminjamanharian.create')); ?>" class="btn btn-lg btn-primary">
                        <i class="fas fa-calendar-day"></i> Peminjaman Harian
                    </a>
                    <a href="<?php echo e(route('peminjamantahunan.create')); ?>" class="btn btn-lg btn-info">
