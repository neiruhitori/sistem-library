...
unset($__errorArgs, $__bag); ?>" name="tahun_terbit"
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="kelas" id="kelas" 
                                    ...
                                    value="<?php echo e(old('kelas', $buku->kelas ?? '-')); ?>" disabled>
                            </div>
                            <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>" name="description" id="description"
                            ...
                            <div class="col-12">
                                ...
                                <?php if(isset($buku) && $buku->foto): ?>
                                    <div class="mt-2">
                                        <img src="<?php echo e(str_starts_with($buku->foto, 'sampulbuku/') ? asset($buku->foto) : asset('storage/' . $buku->foto)); ?>" alt="Foto Buku"
