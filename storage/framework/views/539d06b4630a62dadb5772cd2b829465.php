<?php $__env->startSection('title', 'Peminjaman Harian'); ?>
            ...
            <div class="card shadow mt-3">
                ...
                <div class="card-body">
                    <div class="mb-3 d-flex gap-2">
                        <a href="<?php echo e(route('peminjamanharian.create')); ?>" class="btn btn-success">
                            <i class="fas fa-plus"></i> Tambah Peminjaman
                        </a>
                        <form action="<?php echo e(route('peminjamanharian.hapussemua')); ?>" method="POST"
    ...
    <script>
        $(function() {
            $('#example1').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '<?php echo e(route('peminjamanharian.index')); ?>',
                    type: 'GET',
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sistem-library\resources\views/peminjamanharian/index.blade.php ENDPATH**/ ?>