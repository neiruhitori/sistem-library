<?php $__env->startSection('title', 'Edit Peminjaman Harian'); ?>
        ...
        <div class="container-fluid">
            <div class="card mx-auto shadow" style="max-width: 800px;">
                <div class="card-header bg-primary text-white">
                    <h3 class="card-title"><i class="fas fa-edit"></i> Form Edit Peminjaman Harian</h3>
                </div>
                <form method="POST" action="<?php echo e(route('peminjamanharian.update', $peminjaman->id)); ?>">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sistem-library\resources\views/peminjamanharian/edit.blade.php ENDPATH**/ ?>