...
<head>
    ...
    <style>
        * {
        ...
        .card, .card-back {
            background: white;
            width: <?php echo e($width); ?>px;   /* 85.6mm dalam pixel @ 300 DPI (85.6 * 11.81 = 1012px) */
            height: <?php echo e($height); ?>px;  /* 53.98mm dalam pixel @ 300 DPI (53.98 * 11.81 = 640px) */
            border-radius: 24px;
...
<body>
    <div class="card">
        <div class="card-header">
            <?php if($logoBase64): ?>
                <img src="data:image/png;base64,<?php echo e($logoBase64); ?>" alt="Logo">
            <?php else: ?>
        ...
        <div class="card-content">
            ...
            <div class="info-container">
                <div class="student-name"><?php echo e(strtoupper($siswa->name)); ?></div>
                <div class="info-item">
                    <span class="info-label">ID:</span>
                    <span class="info-value"><?php echo e(str_pad($siswa->id, 4, '0', STR_PAD_LEFT)); ?></span>
                </div>
                <div class="info-item">
                    <span class="info-label">NISN:</span>
                    <span class="info-value"><?php echo e($siswa->nisn ?: '-'); ?></span>
                </div>
                <div class="info-item">
                    <span class="info-label">Kelas:</span>
                    <span class="info-value"><?php echo e(strtoupper($siswa->kelas)); ?></span>
                </div>
            </div>
        </div>
        <div class="year">Valid: <?php echo e(date('Y')); ?></div>
    </div>
    ...
    <div class="card-back">
        ...
        <div class="school-info-back">
            ...
            <small>ID: <?php echo e(str_pad($siswa->id, 4, '0', STR_PAD_LEFT)); ?> | Sistem Perpustakaan Digital</small>
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\laragon\www\sistem-library\resources\views/siswa/card_png.blade.php ENDPATH**/ ?>