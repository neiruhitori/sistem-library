<?php $__env->startSection('title', 'Catatan Harian'); ?>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $catatans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $catatan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('catatanharian.show', $catatan->id)); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sistem-library\resources\views/catatanharian/index.blade.php ENDPATH**/ ?>