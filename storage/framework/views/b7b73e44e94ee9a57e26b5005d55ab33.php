<?php $__env->startSection('title', 'Detail Peminjaman Tahunan'); ?>
    ...
    <div class="container mt-4">
        <div class="card shadow">
            <div class="card-header bg-info text-white">
                <h3 class="card-title"><i class="fas fa-book-reader"></i> Detail Peminjaman Tahunan</h3>
            </div>
            <div class="card-body">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sistem-library\resources\views/peminjamantahunan/show.blade.php ENDPATH**/ ?>