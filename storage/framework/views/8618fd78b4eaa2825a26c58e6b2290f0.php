...
<body>
    ...
    <?php if($catatan->peminjamantahunan && $catatan->peminjamantahunan->details->count()): ?>
            ...
            <tbody>
                ...
                <?php if($detail): ?>
                    <tr>
                        ...
                        <td><?php echo e($detail->kodeBuku->buku->penulis ?? '-'); ?></td>
                        <td><?php echo e($detail->kodeBuku->buku->tahun_terbit ?? '-'); ?></td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
...
<?php /**PATH C:\laragon\www\sistem-library\resources\views/catatantahunan/pdf.blade.php ENDPATH**/ ?>