...
@section('title', 'Edit Lokasi Akses')
            ...
            <div class="row mb-2 align-items-center">
                <div class="col-sm-6">
                    ...
                    <div class="text-muted fw-bold" style="font-size:1.25rem;">
                        Edit lokasi: {{ $allowedLocation->name }}
                    </div>
                </div>
                <div class="col-sm-6">
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="card mx-auto mt-3 shadow" style="max-width: 98%;">
                ...
                <form action="{{ route('admin.allowed-locations.update', $allowedLocation) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror" 
                                       id="name" name="name" value="{{ old('name', $allowedLocation->name) }}" 
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control @error('radius_meters') is-invalid @enderror" 
                                       id="radius_meters" name="radius_meters" value="{{ old('radius_meters', $allowedLocation->radius_meters) }}" 
                        ...
                        <div class="row g-3 mt-2">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('latitude') is-invalid @enderror" 
                                       id="latitude" name="latitude" value="{{ old('latitude', $allowedLocation->latitude) }}" 
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('longitude') is-invalid @enderror" 
                                       id="longitude" name="longitude" value="{{ old('longitude', $allowedLocation->longitude) }}" 
                        ...
                        <div class="row g-3 mt-2">
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" 
                                          ...
                                          placeholder="Deskripsi lokasi...">{{ old('description', $allowedLocation->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="is_active" name="is_active" value="1" 
                                           {{ old('is_active', $allowedLocation->is_active) ? 'checked' : '' }}>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="alert alert-info">
                                    <strong>{{ $allowedLocation->name }}</strong><br>
                                    <span class="coordinate-display">Lat: {{ $allowedLocation->latitude }}</span>, 
                                    <span class="coordinate-display">Lng: {{ $allowedLocation->longitude }}</span><br>
                                    Radius: <span class="badge badge-primary">{{ $allowedLocation->radius_meters }}m</span>
                                    <br>
                                    <a href="https://maps.google.com/?q={{ $allowedLocation->latitude }},{{ $allowedLocation->longitude }}" 
