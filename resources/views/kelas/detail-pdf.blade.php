...
<body>
    ...
    <div class="profile-section">
        <div class="profile-row">
            ...
            <span class="profile-value">{{ $siswa->name }}</span>
        </div>
        <div class="profile-row">
            <span class="profile-label">NISN:</span>
            <span class="profile-value">{{ $siswa->nisn ?? 'N/A' }}</span>
        </div>
        <div class="profile-row">
            <span class="profile-label">Kelas:</span>
            <span class="profile-value">{{ $siswa->kelas }}</span>
        </div>
        <div class="profile-row">
            <span class="profile-label">Terdaftar:</span>
            <span class="profile-value">{{ $siswa->created_at->format('d F Y') }}</span>
        </div>
        <div class="profile-row">
            <span class="profile-label">Tanggal Cetak:</span>
            <span class="profile-value">{{ $tanggalCetak }}</span>
        </div>
    </div>
