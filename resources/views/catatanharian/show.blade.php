            ...
            <div class="row mb-2 align-items-center">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right bg-light px-2 py-1 rounded shadow-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('catatanharian.index') }}">
    ...
    <div class="container mt-4">
        <div class="card shadow">
            ...
            <div class="card-body">
                ...
                @if ($catatan->referensi_id && $catatan->peminjaman)
                ...
                <div class="d-flex justify-content-between align-items-center mt-3">
                    <div>
                        ...
                        @if ($catatan->status === 'belum_dibayar')
                            <a href="{{ route('catatanharian.pay', $catatan->id) }}" class="btn btn-success">
                                <i class="fas fa-credit-card"></i> Bayar Sekarang
                            </a>
                        @endif
                    </div>
                    <div>
                        <a href="{{ route('catatanharian.export', $catatan->id) }}" target="_blank"
