...
@section('title', 'Edit Periode Tahun Ajaran')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('semester') is-invalid @enderror" 
                                        ...
                                        <option value="Ganjil" {{ old('semester', $periode->semester) == 'Ganjil' ? 'selected' : '' }}>
                                            Ganjil (Juli - Desember)
                                        </option>
                                        <option value="Genap" {{ old('semester', $periode->semester) == 'Genap' ? 'selected' : '' }}>
                                            Genap (Januari - Juni)
                                        </option>
                                    </select>
                                    @error('semester')
